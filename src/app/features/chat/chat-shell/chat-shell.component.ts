...
@Component({
  ...
  imports: [CommonModule, RouterOutlet, RouterLink, FormsModule,
            NewChatModalComponent, NotificationsPanelComponent],
  template: `
    <div class="shell">
      <!-- Sidebar -->
          ...
          <div class="brand">
            <div class="brand-icon">
              <svg viewBox="0 0 32 32" fill="none">
                ...
                <defs><linearGradient id="sh1" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
            ...
            <div class="no-chat-content">
              <div class="no-chat-icon">
                <svg viewBox="0 0 80 80" fill="none">
                  ...
                  <path d="M18 28c0-3 2.4-5.5 5.5-5.5H56.5C59.6 22.5 62 25 62 28V46c0 3-2.4 5.5-5.5 5.5H46l-8 6V51.5H23.5C20.4 51.5 18 49 18 46V28z" fill="#7C3AED" opacity=".15"/>
                  <path d="M22 32c0-2.2 1.8-4 4-4H54c2.2 0 4 1.8 4 4V44c0 2.2-1.8 4-4 4H46l-6 4.5V48H26c-2.2 0-4-1.8-4-4V32z" fill="#7C3AED" opacity=".3"/>
  ...
  styles: [`
    ...
    .search-box {
      ...
      margin: 8px 12px 4px; padding: 0 14px;
    ...
    .room-list { flex: 1; overflow-y: auto; padding: 8px 8px; }
    ...
    .unread-badge {
      ...
      padding: 2px 6px; min-width: 18px; text-align: center; flex-shrink: 0;
    }
    /* Skeleton */
